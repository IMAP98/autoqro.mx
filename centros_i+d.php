...
$stmt = $conn->prepare("CALL `sp_Select_Centro_I_+_D`;");
$stmt->execute();
...
<section>
    <div class="portada_centros_aso d-flex align-items-end justify-content-end">
...
<section class="mx-auto col-10">
    ...
    <div class="row info_sec mx-auto justify-content-between">
        <div class="col-9 texto_1">
            <h2 class="fw-semibold titulo"><?php echo $langHeader['CentrosI+D'] ?></h2>
        </div>
