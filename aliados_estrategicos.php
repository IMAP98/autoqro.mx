...
$stmt = $conn->prepare("CALL sp_Select_Aliado_Estrategico;");
$stmt->execute();
...
<section>
    <div class="portada_aliados_aso d-flex align-items-end justify-content-end">
...
<section class="mx-auto col-10">
    ...
    <div class="row info_sec mx-auto justify-content-between">
        <div class="col-9 texto_1">
            <h2 class="fw-semibold titulo"><?php echo $langHeader['AliadosEstrategicos'] ?></h2>
        </div>
