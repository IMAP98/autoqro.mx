...
$stmt = $conn->prepare("CALL sp_Select_TR1;");
$stmt->execute();
...
<section>
    <div class="portada_tr1_aso d-flex align-items-end justify-content-end">
...
<section class="mx-auto col-10">
    ...
    <div class="row info_sec mx-auto justify-content-between">
        <div class="col-8 texto_1">
            <h2 class="fw-semibold titulo"><?php echo $langHeader['Tier1'] ?></h2>
        </div>
