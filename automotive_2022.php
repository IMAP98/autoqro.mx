...
<section class="mx-auto col-9">
    <div class="info_sec">
        <div class="row mb-3">
            <h1 class="titulo">Finaliza el Automotive Supplier Conference 2022</h1>
        </div>
        ...
        <div class="clearfix noticia">
            <img src="https://res.cloudinary.com/cluster-automotriz-de-queretaro/image/upload/v1674660172/IMG_20220517_134911_iglqfs.jpg" class="col-md-6 float-md-end mb-3 ms-md-5 my-auto" alt="...">

            <p>Finalizan los encuentros individuales del Automotive Supplier Conference 2022 con Forvia cómo la décima empresa participante.</p>

            <p>En esta edición se generaron 220 citas con 967 empresas principalmente dedicadas a Empaque, Metalmecánico, MRO's, Plásticos, Servicios especializados, Eléctrico, Tecnologías de comunicación y Textil.</p>
